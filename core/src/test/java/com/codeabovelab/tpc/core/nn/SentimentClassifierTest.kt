...
class SentimentClassifierTest {
    ...
    @Before
    fun prepare() {
        val modelFile = Paths.get("/home/pronto/Downloads/sentiment/output/res-1.zip")
    ...
    fun testNegative() {
        calc("The conference planning meeting did not go well. " +
                ...
                "We may need to pull some overtime on the weekend to catch up. Let's plese get it all together.")
